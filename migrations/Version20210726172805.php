 ...
 */
final class Version20210726172805 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE genre (id INT AUTO_INCREMENT NOT NULL, label VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, deleted_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE instru (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, bpm INT NOT NULL, cle VARCHAR(255) NOT NULL, file VARCHAR(255) DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, modified_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, INDEX IDX_AF2F6724A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE instru_genre (instru_id INT NOT NULL, genre_id INT NOT NULL, INDEX IDX_9432962CD868EB9A (instru_id), INDEX IDX_9432962C4296D31F (genre_id), PRIMARY KEY(instru_id, genre_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE instru_genre ADD CONSTRAINT FK_9432962CD868EB9A FOREIGN KEY (instru_id) REFERENCES instru (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE instru_genre ADD CONSTRAINT FK_9432962C4296D31F FOREIGN KEY (genre_id) REFERENCES genre (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE instru_genre DROP FOREIGN KEY FK_9432962C4296D31F');
        $this->addSql('ALTER TABLE instru_genre DROP FOREIGN KEY FK_9432962CD868EB9A');
        ...
        $this->addSql('DROP TABLE instru_genre');
