...
class ToplineFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $topline1->addInstru($this->getReference('instru1'));
        ...
        $topline2->addInstru($this->getReference('instru5'));
        ...
        $topline3->addInstru($this->getReference('instru4'));
        ...
        $topline4->addInstru($this->getReference('instru3'));
        ...
        $topline5->addInstru($this->getReference('instru7'));
        ...
        $topline6->addInstru($this->getReference('instru10'));
        ...
        $topline7->addInstru($this->getReference('instru11'));
        ...
        $topline8->addInstru($this->getReference('instru9'));
        ...
        $topline9->addInstru($this->getReference('instru7'));
        ...
        $topline10->addInstru($this->getReference('instru5'));
        ...
        $topline11->addInstru($this->getReference('instru2'));
